            ...
            <div className="divide-y divide-gray-50">
                {documents.length === 0 ? (
                    ...
                    <div
                        ...
                        className="flex items-center gap-3 px-5 py-3.5 hover:bg-orange-50/30 cursor-pointer transition-colors"
                    >
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                            ...
                            <span className="text-xs text-gray-400">{timeAgo(doc.lastAccessed)}</span>
                        </div>
                    </div>
                ))}
            </div>
